...
Route::namespace('Auth')
	...
	->group(function ($router) {
		...
		Route::post('password/email', [ForgotPasswordController::class, 'sendResetLink'])->name('auth.password.email');
...
Route::prefix('categories')
	...
	->group(function ($router) {
		...
		Route::post('{id}/fields', 'getCustomFields')->name('categories.fields');
	});
