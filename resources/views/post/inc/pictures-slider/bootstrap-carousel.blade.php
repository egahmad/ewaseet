...
@section('after_scripts')
	...
	<script>
		$(document).ready(function () {
			...
			var picturesCarouselIndicatorsEl = document.querySelector('#picturesCarouselIndicators');
			var carousel = new bootstrap.Carousel(picturesCarouselIndicatorsEl, {
				interval: false,
				ride: false
			});
			...
			$(document).on('mousedown', '.carousel-item img', function (e) {
				...
				var imgTitle = "{{ $post->title }}";
				
				var wrapperSelector = '.carousel-item img:not(.default-picture)';
