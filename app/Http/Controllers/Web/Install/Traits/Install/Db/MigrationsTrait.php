...
trait MigrationsTrait
{
	...
	protected function runSiteInfoSeeder($siteInfo)
	{
		try {
			...
			// Mail
			$driver = (isset($siteInfo['driver']) && !empty($siteInfo['driver']))
				? $siteInfo['driver']
				: 'sendmail';
			...
			$mail[$emailSender] = (isset($siteInfo[$emailSender]) && !empty($siteInfo[$emailSender]))
				? $siteInfo[$emailSender]
				: $appEmail;
