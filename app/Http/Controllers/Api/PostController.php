...
{
	use SearchTrait, VerificationTrait, StoreFieldValueTrait, ShowTrait;
	 ...
	 * List listings
	 *
	 * @queryParam op string Type of listings list (optional) - Possible value: search,sponsored,latest. Example: null
	 * @queryParam logged boolean To list a user's listings. Authentication token need to be sent in the header, and the "op" parameter need be null or unset.
	 * @queryParam pending boolean To list a user's listings in pending. Authentication token need to be sent in the header, and the "op" parameter need be null or unset.
	 * @queryParam archived boolean To list a user's archived listings. Authentication token need to be sent in the header, and the "op" parameter need be null or unset.
	 * @queryParam embed string Comma-separated list of the post relationships for Eager Loading - Possible values: user,category,postType,city,latestPayment,savedByLoggedUser,pictures. Example: null
	 ...
	 * @queryParam embed string Comma-separated list of the post relationships for Eager Loading - Possible values: user,category,postType,city,latestPayment,savedByLoggedUser,pictures.Example: user,postType
	 ...
	 * Note: The field 'admin_code' is only available when the listing's country's 'admin_type' column is set to 1 or 2 and the 'admin_field_active' column is set to 1.
	 *
	 * @authenticated
	 ...
	 * @bodyParam email string The listing's author email address (required if mobile phone number doesn't exist). Example: john.doe@domain.tld
	 * @bodyParam phone string The listing's author mobile number (required if email doesn't exist). Example: +17656766467
	 ...
	 * The field 'admin_code' is only available when the listing's country's 'admin_type' column is set to 1 or 2 and the 'admin_field_active' column is set to 1.
	 *
	 * @authenticated
	 * @header Authorization Bearer {YOUR_AUTH_TOKEN}
	 *
