...
class SavedPostController extends BaseController
{
	 ...
	 * @queryParam embed string The Comma-separated list of the category relationships for Eager Loading - Possible values: user,post. Example: null
	...
	public function index()
	{
		...
		if (in_array('post', $embed)) {
			$savedPosts->with('post')->with(['post.pictures', 'post.city']);
		}
